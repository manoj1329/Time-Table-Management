...
<html>
    ...
    <body>
        <form method="post" action="tcpass1.jsp"/>
        ...
        <center>
            ...
            <center>
                <input type="text" name="cpwd" style="border-radius: 23px;padding: 3px 0px 7px 18px;" value="<%String pswd=(String)session.getAttribute("pwd");
                out.println(pswd);%>" readonly/>
            </center>
            <br>
             <center>
                <label>
            ...
            <center>
                <input type="text" style="border-radius: 23px;padding: 3px 0px 7px 18px;"name="cpwd" id="cp"/>
            </center>
            <center>
